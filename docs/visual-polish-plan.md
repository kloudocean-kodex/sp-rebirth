...
The connected OpenArt workspace currently has 36 credits. The cheapest available video generation configuration is 50 credits (PixVerse V6, 5s, 540p), while the preferred 10s 1080p configuration is materially more expensive. Do not fabricate a generated-video result. Continue safely with the existing local footage and static fallback until credits or another authorized video-generation path are available.
