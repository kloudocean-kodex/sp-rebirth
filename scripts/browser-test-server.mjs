...
export async function startBrowserTestServer({
  ...
  // Browser QA must exercise the exact Worker bundle/config generated by
  // `astro build`. Wrangler's deploy dry-run uses this redirected config too,
  // so using it directly keeps local browser evidence aligned with deployment
  // behavior without overriding Astro's unified Cloudflare entrypoint.
