...
export const siteSettings = defineType({
  ...
  fields: [
    defineField({
      ...
      title: "Business name",
      type: "string",
      initialValue: "Sana Patel Real Estate",
    ...
    defineField({
      ...
      title: "Phone",
      type: "string",
      initialValue: "0416 977 990",
    }),
    defineField({
      name: "email",
      title: "Email",
      type: "string",
      initialValue: "sana@sanapatel.com.au",
    }),
    defineField({
      name: "serviceArea",
      title: "Primary service area",
      type: "string",
      initialValue: "Melbourne, Victoria",
    }),
...
export const reviewReference = defineType({
  ...
  type: "document",
  description:
    "Use only for attributable reviews that can be independently verified. Prefer the Trustindex feed when possible.",
  fields: [
    defineField({
      name: "reviewerName",
      title: "Reviewer name",
    ...
    defineField({
      ...
      title: "Source",
      type: "string",
      options: { list: ["Google", "Trustindex", "Other"] },
      validation: (rule) => rule.required(),
    }),
...
export const resourceArticle = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "array",
      description:
        "Use authoritative sources for legal, tenancy, safety and compliance content.",
      of: [
        defineArrayMember({
          type: "object",
          fields: [
  ...
  orderings: [
    {
      ...
      name: "reviewedAtDesc",
      by: [{ field: "reviewedAt", direction: "desc" }],
    },
  ],
});
...
export const suburbPage = defineType({
  ...
  type: "document",
  description:
    "Create only when the page has genuinely useful local evidence and content. Thin programmatic location pages are not permitted.",
  fields: [
    defineField({
      name: "suburb",
      title: "Suburb",
    ...
    defineField({
      name: "localContext",
      title: "Local property-management context",
      type: "portableText",
      validation: (rule) => rule.required(),
    }),
    defineField({
      name: "usefulFor",
      title: "Why this page deserves to exist",
      type: "text",
      rows: 4,
