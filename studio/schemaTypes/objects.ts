        ...
        annotations: [
          {
            ...
            title: 'Link',
            fields: [
              {name: 'href', type: 'url', title: 'URL', validation: (rule) => rule.uri({allowRelative: true, scheme: ['http', 'https', 'mailto', 'tel']})},
...
export const richTextSection = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      initialValue: 'text',
      options: {list: [{title: 'Text', value: 'text'}, {title: 'Image left', value: 'imageLeft'}, {title: 'Image right', value: 'imageRight'}]},
    }),
  ],
})
...
export const proofSection = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Proof source',
      type: 'string',
      options: {list: [{title: 'Trustindex / Google', value: 'trustindex'}, {title: 'Curated verified references', value: 'curated'}]},
